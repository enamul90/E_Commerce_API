...
import SliderLoader from "../../skeleton/SliderLoader.jsx";
import {Link} from "react-router-dom";
import product from "../../assets/images/img.png"

const Slider = () => {

    let {SliderList} =  ProductStore()
                ...
                <div className=" mb-5">
                    <div id="carouselExampleDark" className="carousel hero-bg carousel-dark slide">
                                        ...
                                        <div key={index} className={active} data-bs-interval="10000">
                                            <div className="container ">
                                                <div className="row justify-content-center">
                                                    <div className="col-12 col-lg-5 col-sm-12 col-md-5 px-5 d-flex align-items-center">
                                                        <div>
                        ...
                        <button className="carousel-control-next btn" type="button"
                                data-bs-target="#carouselExampleDark" data-bs-
                                slide="next">
